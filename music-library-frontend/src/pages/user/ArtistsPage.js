...
import { getArtists } from '../../services/otherServices';
...
const ArtistsPage = () => {
  ...
  const { data: artists, loading } = useApi(getArtists);
      ...
      <div className="page-header fade-in">
        <div>
          ...
          <p className="page-subtitle">
            {artists ? `${artists.length} artists available` : '…'}
          </p>
        </div>
      </div>
            ...
            : filtered?.map((artist) => (
              ...
              >
                ...
                <div className="entity-info">
                  <h3 className="entity-name">{artist.artistName}</h3>
                  <span className="badge badge-lime">Artist</span>
                </div>
              </div>
            ))
        }
